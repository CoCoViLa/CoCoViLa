...
public class Shape
	...
	public boolean contains(int pointX, int pointY) {
		if ( (pointX > x + (int) (size * portOffsetX1)) && (pointY > y + (int) (size * portOffsetY1))) {
			if ( (pointX < x + (int) (size * (width + portOffsetX2)) && (pointY < y + (int) (size * (height + portOffsetY2))))) {
				return true;
			}
		}
		return false;
	...
	public boolean isInside(int x1, int y1, int x2, int y2) {
		if ( (x1 < x + portOffsetX1) && (y1 < y + portOffsetY1)) {
			if ( (x2 > x + (int) (size * width) + portOffsetX2) && (y2 > y + (int) (size * height) + portOffsetY2)) {
				return true;
			}
		}
		return false;
