...
public class Dot extends Shape implements Serializable {
     ...
     * 
     * @return boolean - a boolean value indicating if the shape is selected or
     *         not.
     */
    ...
    /**
     * Returns the width of the dot (the difference between the dot's beginning
    ...
    /**
     * Returns the height of the dot (the difference between the dot's beginning
    ...
    public String toFile(int boundingboxX, int boundingboxY) {
        ...
        return "<rect x=\"" + (x - boundingboxX) + "\" y=\""
                ...
                + height + "\" colour=\"" + colorInt + "\" fixed=\""
                + isFixed() + "\" stroke=\"" + (int) this.lineWeight
                + "\" transparency=\"" + (int) this.transparency + "\"/>\n";
    } // toFile
    ...
    public String toText() {
        ...
        if (color != null)
            colorInt = color.getRGB();
        return "DOT:" + x + ":" + y + ":" + width + ":" + height + ":"
                + colorInt + ":" + (int) this.lineWeight + ":"
                + (int) this.transparency + ":" + isFixed();
    } // toText
     ...
     *            Graphics
     */
    public void draw(int xModifier, int yModifier, float sizeX, float sizeY,
            Graphics2D g2) {
        g2.setStroke(stroke);
        g2.setColor(color);
