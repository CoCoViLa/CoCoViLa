...
public class Arc extends Shape implements Serializable, Cloneable {
	...
	public Arc(int x, int y, int width, int height, int startAngle, int arcAngle,
			   int colorInt, boolean fill, double strokeWidth, int transp, int lineType) {
		this.x = x;
		this.y = y;
		this.width = width;
		this.height = height;
	...
	public String toText() {
		...
		return "ARC:" + x + ":" + y + ":" + width + ":" + height + ":" + startAngle + ":" + arcAngle + ":" + colorInt + ":" + fill + ":" + stroke.getLineWidth() + ":" + this.getLineType() + ":" + color.getTransparency() + ":" + isFixed();
	} // toText
