	...
	public String generateSpec(Scheme scheme, String className) {
		...
		for (int i = 0; i < objects.size(); i++) {
			...
			if(obj instanceof SchemeObj) {
			    SchemeContainer container = new SchemeContainer( scheme.getContainer().getPackage(), scheme.getContainer().getWorkDir() );
			    File schemeFile = new File(scheme.getContainer().getWorkDir(), 
			            obj.getClassName() + "." + CustomFileFilter.EXT.SYN.getExtension());
			    if(schemeFile.exists()) {
			        ...
			        String spec = "/* NB! Automatically generated by CoCoViLa, do not edit this file (it may be overwritten)*/\n\n" +  
			            generateSpec( container.getScheme(), obj.getClassName() );
			        
			        try {
			            FileWriter writer = new FileWriter( 
			                    new File(schemeFile.getParentFile(), 
			                            obj.getClassName() + "." + getFileFilter().getExtension() ) );
			        ...
			        System.err.println( "Scheme does not exit!" + obj.getClassName());
			}
		}
