	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource().getClass().getName() == "javax.swing.JMenuItem" ||
			...
			if (e.getActionCommand().equals(Menu.SAVE_SCHEME)) {
				...
				ProgramTextEditor programEditor = new ProgramTextEditor(editor.getCurrentCanvas().connections, editor.getCurrentCanvas().objects, editor.getCurrentCanvas().vPackage, editor);
