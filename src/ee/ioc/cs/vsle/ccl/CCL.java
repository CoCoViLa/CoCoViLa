 ...
 * <p>Description: A CompilingClassLoader compiles Java source on-the-fly.
 *                 It checks for nonexistent .class files, or .class files that
...
public class CCL
	...
	/**
	 * Given a file name, reads the entirety of that file from disk and return it as a byte array.
	 * @param filename String - name of the file to be read.
	 * @return byte[] - byte stream of the file read.
	 * @throws java.io.IOException - Input/Output Exception thrown at reading the file.
	 */
	...
	/**
	 * Spawns a process to compile the java source code file
	 * specified in the 'javaFile' parameter. Return a true if
	 * the compilation worked, false otherwise.
	 * @param javaFile String - name of the Java file to be compiled.
	 * @return boolean - indicates whether the compilation succeeded or not.
	 * @throws java.io.IOException - Input/Output exception at reading the file.
	 * @throws ee.ioc.cs.vsle.ccl.CompileException - Exception at compilation.
	 */
	public boolean compile(String javaFile) throws IOException, CompileException {
		javaFile = RuntimeProperties.genFileDir + System.getProperty("file.separator") + javaFile + ".java";
	...
	/**
	 * Perform an automatic compilation of sources as necessary when looking for class files.
	 * If the source modification is dated/timed later than the class files, then a recompilation
	 * will be performed. Otherwise the file is skipped.
	...
	public Class loadClass(String name, boolean resolve) throws ClassNotFoundException {
		...
		String classFilename = RuntimeProperties.genFileDir + System.getProperty("file.separator") + fileStub + ".class";
		...
		catch (IOException ie) { // This is not a failure! If we reach here, it might
