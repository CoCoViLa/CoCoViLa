...
public class JavaToken extends Token {
  ...
  public final static int RESERVED_WORD_SPECIFICATION = 0x130;
  
  public final static int RESERVED_WORD_ALIAS = 0x131;
  ...
  public final static int SPEC_BEGIN = 0x601;
  public final static int SPEC_END = 0x602;
  ...
  public final static int COMMENT_SPEC = 0xD40;
  ...
  public boolean isSpecReservedWord(){
  	return ID == 0x130;
  }
  ...
  public boolean isError(){
	...
	public String getDescription(){
		if (isSpecReservedWord()){
				return("specReservedWord");
