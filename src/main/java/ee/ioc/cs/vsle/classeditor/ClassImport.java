...
public class ClassImport {
	...
	/* @TODO proper class and template objects*/
 ...
 */
	public ClassImport(File file,  ArrayList <String> packageClasses, ArrayList <ClassObject> classes, ArrayList <String> templates){
	...
	class ClassHandler extends DefaultHandler {
		...
		public void startElement(String namespaceURI, String lName, String qName,
			...
			if(element.equals("class")){
                ...
                classObj.setComponentType( ComponentType.getType( type ) );
		...
		public void endElement(String namespaceURI, String sName, String qName) {
			...
			if (element.equals("class")){
				inClass = false;
				classObj.shapeList = shapeList;
				classObj.ports = ports;
			...
			if(element.equals("description") && inClass){
				classObj.setClassDescription(charBuf.toString());				
				inDesc = false;
			}
			if(element.equals("icon")){
				classObj.setClassIcon(charBuf.toString());				
				inIcon = false;
			}
